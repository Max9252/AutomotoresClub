    ...
    function sendInfo(){
        $('#sendInfoBody').append("<p align='center'>A su correo electrónico: "+$('#email').val()+", se le enviará información detallada respecto a la membresía de Asociado a AUTOMORES CLUB SAS.</p>");
        $("#modelInfoA").modal('show');
    ...
    function submitForm() {
        ...
        if (validator.isValid()) {
            ...
            $('#infomsg').append("<p align='center'>A partir de ahora queda activa la membresia inicial para tu "+$('#claseV').val()+" / "+$('#marca').val()+" / "+$('#linea').val()+" de placa: "+($('input[name="placa"]').val()).toUpperCase()+".</p>");
            $('#infomsg').append("<p align='center'>El valor de esta membresia inicial es de $0.00 y tiene una vigencia de "+diasRestantes()+" días, según la fecha de vencimiento de su SOAT.</p>");
    ...
    function submitFormP() {
        ...
        if (validator.isValid() && aux && aux2) {
                $('#infomsg2').append("<p align='center'>Su usuario de ingreso para AUTOMOTORES CLUB es: #######</p>");
                ...
                $('#infomsg2').append("<p align='center'>De 1mil hasta 5mil volantes por mes, lo mantendrá como proveedor CLASSIC.<br>Entre 6mil y 20mil volantes por mes, lo mantendrá como proveedor PREMIUM.<br>Despues de 21mil volantes por mes, lo mantendrá como proveedor SPECIAL.</p>");
    ...
    function submitInformacionP(){
       $('#infomsg4').append("<p align='center'>A su correo electrónico: "+$('#emailCP').val()+", se le enviará información más detallada respecto a la membresía como Proveedor para AUTOMOTORES CLUB SAS.</p>");
       $("#modalRegistroP").modal('hide');
       $('#modelInfoP').modal('show');
    }
